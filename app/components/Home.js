...
class Home extends React.Component {
  ...
  render() {
    ...
    var myWorkouts = this.state.workouts
      .map(item => (
        <div
    ...
    var mySavedWorkouts = this.state.savedWorkouts
      .map(item => (
        <div
          className="list-group-item"
          key={item._id}
      ...
      <div className="container-fluid" id="home">
          ...
          <div className="text-center" id="home-header">
            <div className="row home-option" id="home-create">
              <div className="col-xs-12 text-center">
                <Link to="/create/type">
                  <img className="img-responsive" src="../images/64px-icons/weights.png" />
            ...
            <div className="row home-option" id="home-search">
              <div className="col-xs-12 text-center">
                <Link to="/following">
                  <img className="img-responsive" src="../images/64px-icons/followers.png" />
                  <h5>Your Friends</h5>
                </Link>
              </div>
            </div>
            <div className="row home-option" id="home-friends">
              <div className="col-xs-12 text-center">
                <Link to="/friendsearch">
                  <img className="img-responsive" src="../images/64px-icons/006-search.png" />
        ...
        <div className="col-xs-12 col-sm-6">
          <div className="container-fluid exercise-holder">
            ...
            <hr />
            <ul className="list-group home-workout-list">{myWorkouts}</ul>
          </div>
          <br />
          <div className="container-fluid exercise-holder">
            <h3>Your Saved Workouts</h3>
            <hr />
            <ul className="list-group home-workout-list">{mySavedWorkouts}</ul>
          </div>
        </div>
      </div>
    )
