    ...
    return (
      <div className="well text-center">
        ...
        <button
          ...
          onClick={() => {
            this.setExercise(this.props.exercises)
          }}>
          View
        </button>
        <button
          ...
          onClick={() => {
            this.props.saveExercise(this.props.id)
          }}
          data-dismiss="modal">
          Save
        </button>
        ...
        <div className="row">
          ...
          <br />
          <button className="btn btn-danger show-hide" id={this.props.id} onClick={this.clearExercises}>
            Hide
          </button>
        </div>
      </div>
