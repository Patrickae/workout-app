  ...
  render() {
    ...
    const repSelector = this.state.reps.map((item, index) =>
      ...
      <div className="form-group col-xs-6">
        <input type="number" value={item} className="form-control" ref="setsNumber" readOnly required></input>
      </div>
      <div className="pull-left col-xs-3">

        <img src="../images/64px-icons/minus.png" className="img-responsive" onClick={() => {
          this.subtractReps(index)
        }}></img>
      </div>
      <div className="pull-right col-xs-3">

        <img className="img-responsive" src="../images/64px-icons/plus.png" onClick={() => {
          this.addReps(index)
        }}></img>
      </div>
      ...
      <div className="container">
        <div className="row">
          <form onSubmit={this.props.handleSubmit}>
            ...
            <div className="form-group col-xs-6">
              ...
              <input type="number" value={this.state.reps.length} className="form-control" ref="setsNumber" readOnly required></input>
            </div>

            <div className="pull-left col-xs-3">
              <img className="img-responsive" src="../images/64px-icons/minus.png" onClick={this.subtractSets}></img>
            </div>
            <div className="pull-right col-xs-3">
              <img className="img-responsive" src="../images/64px-icons/plus.png" onClick={this.addSets}></img>
            </div>
        ...
        <div className="row">
          ...
          <Link to="/create/exercises/time">
            <img className="img-responsive" src="../images/64px-icons/check.png" onClick={() => this.props.setParent(this.state.reps)}></img>
          </Link>
