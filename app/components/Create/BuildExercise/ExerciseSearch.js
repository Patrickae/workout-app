...
class ExerciseSearch extends React.Component {
  ...
  render() {
    var exercisesDisplay = this.state.exerciseList.map(data => <ExerciseComp addExercise={this.props.setParent} exerciseName={data.exerciseName} id={data._id} key={data._id} URL={data.URL} image={data.image}/>);
    return (
        ...
        <div className="row">
          <form className="form-horizontal">
            ...
            <div className="pull-right">
              <img className="img-responsive" src="../images/64px-icons/006-search.png" onClick={this.filterExercise}/>
            </div>
          </form>
        </div>
