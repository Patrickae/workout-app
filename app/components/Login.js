    ...
    return (
      <div className="container">
        ...
        <form className="form-signin" action="/new/login" method="post">
          ...
          <br />
          <button className="btn btn-lg btn-success btn-block" type="submit" value="Log In" onClick={this.getUserId}>
            Sign in
          </button>
          <br />
        </form>
        <Link to="/register" className="btn btn-lg btn-info btn-block">
          Register
        </Link>
        <br />
      </div>
