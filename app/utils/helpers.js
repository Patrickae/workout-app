...
var helpers = {
	...
	saveExercise: function(name, url, target, image, mechanics) {
		...
		return axios.post('/api/exercises', newExercise).then(function(response) {
	...
	saveWorkout: function(workout) {
		return axios.post('/api/workouts', workout).then(function(response) {
			return response.data._id
		})
	},
	...
	getUserByUsername: function(name) {
		return axios.get('/api/users/' + name).then(function(response) {
			return response.data
		})
	},

	getUserById: function(id) {
		return axios.get('/api/users/id/' + id).then(function(response) {
			return response.data
		})
	},
